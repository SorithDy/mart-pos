// Request handlers and business logic for the API.
function registerControllers(app, deps) {
  const { Product, Customer, Sale, Employee, Promotion, KHQRGenerate, Login, Receipt, ProductCategory, upload, uploadStaffImage, imageDir, staffImageDir, fs, path, crypto, axios, BakongKHQR, khqrData, MerchantInfo, emitRealtime, PASSWORD_HASH_PREFIX, PASSWORD_HASH_ITERATIONS, PASSWORD_HASH_KEYLEN, PASSWORD_HASH_DIGEST } = deps;
